...
def exibir_comparacao_aves(ave_1, ave_2):
    ...
    imprimir_linha_comparacao(
        "Campo", ave_1["nome_popular"], ave_2["nome_popular"]
    )
    print("-" * 78)
    imprimir_linha_comparacao(
        "Nome científico",
    ...
    imprimir_linha_comparacao(
        "Família", ave_1.get("familia"), ave_2.get("familia")
    )
    imprimir_linha_comparacao(
        "Dieta", ave_1.get("dieta_tipo"), ave_2.get("dieta_tipo")
    )
    imprimir_linha_comparacao(
        "Habitat", ave_1.get("habitat"), ave_2.get("habitat")
    )
    imprimir_linha_comparacao(
        "Comprimento",
...
catalogo_aves = [
    ...
    },
    {
        ...
        "habitat": "Savanas, matas ciliares e bordas de florestas",
        "comprimento_cm": 56,
        "peso_g": 540,
        "status_conservacao": "Pouco preocupante",
        "indice_conservacao": 1,
        "alimentacao": "Frutos, ovos e pequenos vertebrados",
        "curiosidade": "Possui o maior bico em relação ao tamanho do corpo entre todas as aves.",
    },
    {
        "id": 5,
        ...
        "habitat": "Jardins, parques e áreas abertas",
        "comprimento_cm": 19,
        "peso_g": 9,
        "status_conservacao": "Pouco preocupante",
        "indice_conservacao": 1,
        "alimentacao": "Néctar de flores e pequenos insetos",
        "curiosidade": "Sua cauda bifurcada em formato de tesoura representa quase metade do seu comprimento.",
    },
]
